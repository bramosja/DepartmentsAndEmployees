...
using DepartmentAndEmployees.Models;

namespace DepartmentAndEmployees.Data
{
    /// <summary>
    ...
    public class Repository
    {
        ...
        public SqlConnection Connection
        {
            get
            {
                ...
                string _connectionString = "Server=DESKTOP-7NJP9DV\\SQLEXPRESS;Database=DepartmentsAndEmployees;Trusted_Connection=True;Initial Catalog=DepartmentsAndEmployees.sql;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public void AddEmployee(Employee employee)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = $@"INSERT into Employee VALUES (@FirstName, @LastName, @DepartmentId)";
